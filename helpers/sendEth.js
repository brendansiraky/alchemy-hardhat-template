...
const { provider, signer, config: { CHAIN_ID } } = require('../config')
...
async function getTx(to, amount) {
    ...
    const gasLimitAddTenPercent = Math.floor(gasLimit.toString() * 1.1).toString()
...
sendEth('0xd05f9fF8832e2b4eE8A234B5531E830368eb5C0C')